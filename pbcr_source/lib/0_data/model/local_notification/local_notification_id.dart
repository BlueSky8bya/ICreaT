class LocalNotificationID {
  ...
  LocalNotificationID({
    ...
    notiId = ruleId * _ruleIdMultiplier + dateValue;
  }

  factory LocalNotificationID.fromId(int id) {
  ...
  int get ruleId => notiId ~/ _ruleIdMultiplier;

  String get yyyyMMdd {
    final dateValue = notiId % _ruleIdMultiplier + _minYear * 10000;
