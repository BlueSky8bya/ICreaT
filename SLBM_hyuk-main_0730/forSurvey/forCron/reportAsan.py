...
directory_path = f"/home/hyolim/SLBM_hyuk-main/forRun/toReport/{formatted_today}"
...
def daily_report_send():
    ...
    # 계정 정보 설정
    username = "hyolimbook@gmail.com"
    password = "okejeuxrbwuncwtc"

    # 메일 작성
    msg = MIMEMultipart('alternative')
    msg['Subject'] = "[디정플_아산] 피험자 데일리 리포트입니다."
    msg['From'] = username
    # recipients = ["qkrgusrb0120@naver.com", "hyolimbook@gmail.com"]
    recipients = ["hyolimbook@gmail.com"] ###### 테스트용 위가 진짜 - 효림
...
def survey_report_send():
    ...
    msg['From'] = username
    # recipients = ["qkrgusrb0120@naver.com", "plzgiveme45@gmail.com"] # 원래
    recipients = ["hyolimbook@gmail.com"] # 테스트용
